      ...
      <ul className="flex items-center justify-center gap-2">
        ...
        <li>
          <button
            ...
            className="flex h-10 min-w-10 items-center justify-center rounded-lg border border-stroke bg-white px-2 text-base font-medium text-dark hover:bg-gray-1 disabled:opacity-50 dark:border-white/10 dark:bg-white/5 dark:text-white dark:hover:bg-white/10"
          >
            <svg
              width="20"
              height="21"
          ...
          return (
            <li key={page}>
              <button
                ...
                className={`flex h-10 min-w-10 items-center justify-center rounded-lg px-3 text-base font-medium
                  ${
                    isActive
                      ? "border border-primary bg-primary text-white"
                      : "border border-stroke bg-white text-dark hover:bg-gray-1 dark:border-white/10 dark:bg-white/5 dark:text-white dark:hover:bg-white/10"
                  }`}
              >
                {page}
              </button>
