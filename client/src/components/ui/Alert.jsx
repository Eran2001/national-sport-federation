...
const Alert = ({ title, description }) => {
  return (
    <div className="flex w-full rounded-lg border-l-4 border-[#facc15] bg-[#fffbeb] px-7 py-8 md:p-9">
      {/* Warning Icon */}
      <div className="bg-[#facc15] mr-5 flex h-[34px] w-[34px] items-center justify-center rounded-md">
        <svg
          width="18"
          height="18"
          viewBox="0 0 18 18"
      ...
      <div className="w-full">
        <h5 className="mb-3 text-lg font-semibold text-[#92400e]">
          {title || "Attention needed"}
        </h5>
        <p className="text-base leading-relaxed text-[#b45309]">
          {description ||
